...
export default function footer() {
  return (
    ...
    <div className='mobile-footer py-6 bg-black flex flex-col justify-center items-center'>
        ...
        <div className="mobile-upper-links flex flex-col w-full justify-start items-start text-white gap-5 mt-8 ml-8" id='upper-all-links'>
                ...
                <h3 className='text-slate-300 mt-4'>©2024 TATA Consultancy Services Limited</h3>
            </div>
    </div>
    </>
  )
